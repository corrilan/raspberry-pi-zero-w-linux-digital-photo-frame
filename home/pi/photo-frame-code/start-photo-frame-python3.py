...
# apt-get install lightdm libmagickwand-dev python3-pip php7.4-mysql php-bcmath php-gd php7.4-xml x11vnc composer git plymouth apache2 php maria-db-server bc unclutter omxplayer python-rpi-gpio python-imaging python-image-tk imagemagick openssh-server vim autossh screen sshfs xidle xdotool nfs-utils impressive exiftran python3-dev libjpeg-dev zlib1g-dev arp-scan
